...
Система включает production-ready логирование всех событий приложения:

- **Логирование HTTP запросов:**
  - Все запросы с методом, путем, IP адресом
...
- **Логирование действий пользователей:**
  - Все операции с товарами, категориями, заказами
  - Операции с корзиной
  - Редактирование профиля
  - Оформление заказов
...
- **Логирование аутентификации:**
  ...
  - Неудачные попытки входа (с IP адресом)
  - Попытки входа в деактивированные аккаунты

- **Логирование ошибок:**
  - Все ошибки приложения с полным контекстом
  - Полный стектрейс для исключений
  - Информация о запросе, пользователе, IP адресе

- **Особенности:**
  - Ротация файлов логов (автоматическая при достижении лимита)
...
- `logs/requests.log` - HTTP запросы
- `logs/actions.log` - действия пользователей и администраторов
- `logs/auth.log` - события аутентификации
...
- **Логирование и аудит:**
  ...
  - Production-ready система логирования с ротацией файлов
